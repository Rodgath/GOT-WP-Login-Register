...
# Option parameters
$parameters = array(
	'option_name'      => 'gotwplr_options', # must be unique. Used to save settings.
	'option_prefix'    => 'gotwplr_panel', # must be unique. Not used to save settings.
	...
	'page_slug'        => 'gotwplr_panel', # should be unique.
	'page_title'       => __('GOT WP LR Panel', 'dilaz-panel'), # The text to be displayed in the title tags of the page when the menu is selected.
	'menu_title'       => __('GOT WP LR Panel', 'dilaz-panel'), # The text to be used for the menu.
	...
	'import_export'    => false, # 'true' to enable import/export field.
